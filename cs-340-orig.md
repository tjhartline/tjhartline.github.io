...
For the original version, we read a .csv file and added that manually to the MongoDB. I was required to create the database, the collection, and then load the records by scripting in the terminal. Here is an image taken as proof of the database creation.
